...
-- ============================================
-- 11. Seata AT 模式 undo_log 表（分布式事务回滚日志）
-- ============================================
...
-- ============================================
-- 15. 插入管理员账户（密码: lw211014ly）
--    用户类型: 3-管理员
--    使用 BCrypt 加密
-- ============================================
INSERT IGNORE INTO `user` (`username`, `password`, `phone`, `email`, `real_name`, `user_type`, `status`) VALUES
('admin', '$2b$12$FdsNwAE/dVhoVmQR16ry7.QInGa19ER2Gvyq/aF6gkfZ/Mol4Fwty', '13800138000', 'admin@homeservice.com', '系统管理员', 3, 1);

-- ============================================
-- 16. 初始化数据 - 系统配置
-- ============================================
INSERT IGNORE INTO `sys_config` (`config_key`, `config_name`, `config_value`, `config_type`, `config_group`, `remark`, `status`) VALUES
...
SELECT '>>> 管理员账户: admin / lw211014ly' AS message;